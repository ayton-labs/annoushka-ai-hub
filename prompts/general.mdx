...
<img
  src="https://res.cloudinary.com/dqv6k4ijy/image/upload/v1761913635/Screenshot_2025-10-31_at_12.27.05_n5i5l3.png"
  alt="General Productivity"
...
<AccordionGroup>
  ...
  <Accordion title="Feedback & Review">
  ...
  <Accordion title="Research & Information Gathering">
  ...
  <Accordion title="Planning & Organization">
    ### Project Planning
    ```
  ...
  <Accordion title="Scenario Planning">
    ### "What-If" Analysis
    ```
  ...
  <Accordion title="Creative Ideation">
