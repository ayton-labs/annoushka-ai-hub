...
<img
  src="https://res.cloudinary.com/dqv6k4ijy/image/upload/v1760688076/Screenshot_2025-10-17_at_09.01.10_uldxhp.png"
  alt="ChatGPT Projects - Your Custom AI Assistant"
...
### Watch: Build Your First Project in 3 Minutes

See the complete setup process - from creating a new Project, adding custom instructions, uploading files, to testing it with a real Annoushka task.

<Frame caption="Step-by-step walkthrough: Create your first ChatGPT Project from scratch">
  <iframe
    src="https://www.loom.com/embed/a5cc3bfb7f4f47bb9be31bf725f46b8a?hide_share=true&hideEmbedTopBar=true"
    className="w-full aspect-video rounded-xl"
    frameBorder="0"
    allowFullScreen
    title="ChatGPT Projects Setup Tutorial"
  ></iframe>
</Frame>
...
<Frame>
  <img src="https://res.cloudinary.com/dqv6k4ijy/image/upload/v1760693665/Screenshot_2025-10-17_at_10.34.12_v0o84i.png" alt="Example of a ChatGPT Project with multiple files uploaded providing context" />
</Frame>

*Example: A well-organized Project with multiple reference files that ChatGPT can access in every conversation*
